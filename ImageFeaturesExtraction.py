# -*- coding: utf-8 -*-
"""
Created on Sat Jul 30 13:20:47 2022
...
import os
#%%
path='D:\\Python\\datasets\\ImageFeaturesExtraction\\un.png'
#%%
img_building = cv2.imread(os.path.join(path))
...
#%%
# Feature Matching
#extract the same features from the image that is taken from a different angle
...
#%%
orb = cv2.ORB_create()
draw_image_matches(orb, path, path)
